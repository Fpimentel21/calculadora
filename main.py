...
class tela():
    def __init__(self):
        ...
        ### FUNÇÃO RESPONSÁVEL POR DISPOR OS NÚMEROS NO DISPLAY SEPARANDO NÚMEROS E OPERADORES MATEMÁTICOS ### 
        def calcular(self):
            Digitos=[]
            Oper=[]
            Num=[]
        ...
        self.auxBt10.set("-")
        self.bt10=tk.Button(self.tela, textvariable=self.auxBt10, width=self.WIDTH, height=self.HEIGHT, bg="light gray", font=self.FONTE, command=lambda : atualizar(self.auxBt10.get()))
        ...
        self.auxBt11.set("+")
        self.bt11=tk.Button(self.tela, textvariable=self.auxBt11, width=self.WIDTH, height=self.HEIGHT, bg="light gray", font=self.FONTE, command=lambda : atualizar(self.auxBt11.get()))
        ...
        self.auxBt12.set("/")
        self.bt12=tk.Button(self.tela, textvariable=self.auxBt12, width=self.WIDTH, height=self.HEIGHT, bg="light gray", font=self.FONTE, command=lambda : atualizar(self.auxBt12.get()))
        ...
        self.auxBt13.set("X")
        self.bt13=tk.Button(self.tela, textvariable=self.auxBt13, width=self.WIDTH, height=self.HEIGHT, bg="light gray", font=self.FONTE, command=lambda : atualizar(self.auxBt13.get()))
        ...
        self.auxBt14.set("=")
        self.bt14=tk.Button(self.tela, textvariable=self.auxBt14, width=self.WIDTH, height=self.HEIGHT, bg="light gray", font=self.FONTE, command=lambda : calcular(self))
